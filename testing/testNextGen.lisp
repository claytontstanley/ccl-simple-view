...
(open-stream)
(get-xplane "init")
(get-xplane "parkbrake"); 0)
(get-xplane "joystick-override"); 0)
(get-xplane "joystick-override-roll"); 1)
(set-xplane "parkbrake" 0)
(set-xplane "joystick-override" 0)
(set-xplane "joystick-override-roll" 1)
(print-visicon)
