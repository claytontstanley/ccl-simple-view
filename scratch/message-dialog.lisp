...
(let ((string "hello")
  ...
  (print (front-window))
  (#/makeKeyWindow (cocoa-ref (front-window)))
  (#/isKeyWindow (cocoa-ref (front-window))))
(front-window)
...
(progn 
  (sleep 5) 
  (print (front-window))
  (print (#/isKeyWindow (cocoa-ref (front-window))))
  (print (#/isMainWindow (cocoa-ref (front-window)))))
(#/canBecomeKeyWindow (cocoa-ref *))
(#/makeKeyWindow (cocoa-ref *))
(#/enableKeyEquivalentForDefaultButtonCell (cocoa-ref (front-window)))
